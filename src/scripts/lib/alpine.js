;(() => {
	...
	var it = new MutationObserver(nt),
		ot = !1
	function se() {
		it.observe(document, {
			subtree: !0,
...
`
	...
	p(
		...
		(e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
			typeof n == "function" && (n = i(n)),
				n !== !1 && (!n || typeof n == "boolean" ? Ln(e, r, t) : $n(e, n, t))
		}
	)
	function $n(e, t, r) {
		br(e, fe, ""),
	...
	var Le = (e) => {
		...
		ti = /-(\w)/g,
		ys = Le((e) => e.replace(ti, (t, r) => (r ? r.toUpperCase() : ""))),
		ri = /\B([A-Z])/g,
		bs = Le((e) => e.replace(ri, "-$1").toLowerCase()),
	...
	function Fe(e = !1, t = !1) {
		return function (n, i, o) {
			...
			if (i === "__v_raw" && o === (e ? (t ? mi : Ur) : t ? pi : qr).get(n))
				return n
			let s = B(n)
			if (!e && s && he(je, i)) return Reflect.get(je, i, o)
			let a = Reflect.get(n, i, o)
			return (ke(i) ? Hr.has(i) : ci(i)) || (e || R(n, "get", i), t)
				? a
				: Nt(a)
				? !s || !$e(i)
					? a.value
	...
	function Gr(e = !1) {
		return function (r, n, i, o) {
			...
			return (
				r === g(o) && (a ? Tt(i, s) && K(r, "set", n, i, s) : K(r, "add", n, i)), c
			)
		}
	}
	function gi(e, t) {
	...
	var Jr = { get: li, set: hi, deleteProperty: gi, has: xi, ownKeys: yi },
		Yr = {
			get: fi,
			set(e, t) {
				return (
	...
	function Qr(e, t) {
		...
		let s = i.call(r, e)
		return (
			r.set(e, t), o ? Tt(t, s) && K(r, "set", e, t, s) : K(r, "add", e, t), this
		)
	}
	function en(e) {
		let t = g(this),
	...
	y(
		"refs",
		(e) => (e._x_refs_proxy || (e._x_refs_proxy = F(Ai(e))), e._x_refs_proxy)
	)
	function Ai(e) {
		let t = [],
			r = e
	...
	p("model", (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
		...
		let c = () => {
			...
			l = (m) => {
				let v
				s((k) => (v = k)),
					mn(v) ? v.set(m) : a(() => {}, { scope: { __placeholder: m } })
			}
		typeof r == "string" &&
			e.type === "radio" &&
			h(() => {
